    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-success mt-5">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'admin.patient.store', 'method' => 'post']) !!}
                    <div class="form-group">
                        {!! Form::label('identify', 'National ID', ['class' => 'control-label']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('hospital_id', ['' => '-- Select One --'] + $hospitals , null , ['class' => 'form-control']) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label('doctor_id', 'Doctor', ['class' => 'control-label']) !!}
                        {!! Form::select('doctor_id', ['' => '-- Select One --'] + $doctors , null , ['class' => 'form-control']) !!}
                    </div>
                    {{--<div class="form-group">
