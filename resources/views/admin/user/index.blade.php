        ...
        <div class="col-md-12">
            <div class="card mt-5">
                <div class="card-header">
                    <h3 class="card-title"> <i class="fas fa-user-md "></i> All Users List</h3>
                    @if(Auth::user()->hasPermission('create-user'))
                        <a href="{{ route('admin.user.create') }}" class="btn btn-success btn-sm float-right"><i class="fa fa-plus"></i> {{ __('trans.create') }}</a>
                    @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(Auth::user()->hasPermission('delete-user'))
                                            {!! Form::open(['route' => ['admin.user.destroy' , $user -> id], 'method' => 'DELETE', 'style' => 'display:inline']) !!}
